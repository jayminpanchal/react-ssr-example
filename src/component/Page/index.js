...
const defaultTitle = 'React SSR Example';
const defaultDescription = 'This is a react ssr example with ant design library.';
const defaultImage = `${defaultUrl}/images/logo.jpg`;
const defaultTwitter = '@jayminp10';
const defaultSep = ' | ';
...
class Page extends Component {
  ...
  render() {
    ...
    return (
      <div id={id} className={className} style={{padding:24}}>
        <Helmet
          htmlAttributes={{
            lang: 'en',
            itemscope: undefined,
